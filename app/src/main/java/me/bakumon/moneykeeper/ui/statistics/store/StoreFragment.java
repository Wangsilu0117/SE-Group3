...
public class StoreFragment extends BaseFragment {
    ...
    private static final String TAG = me.bakumon.moneykeeper.ui.statistics.store.StoreFragment.class.getSimpleName();
    ...
    protected void onInit(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this, viewModelFactory).get(StoreViewModel.class);
    ...
    private void navTypeRecords(String typeName, int typeId) {
        if (getContext() != null) {
            Floo.navigation(getContext(), Router.Url.URL_STORE_TYPE_RECORDS)
    ...
    private void getStoreSumMoney() {
        Log.v(TAG, "跳：进入商家getStoreSumMoney");
        mDisposable.add(mViewModel.getStoreSumMoney(mYear, mMonth, mType)

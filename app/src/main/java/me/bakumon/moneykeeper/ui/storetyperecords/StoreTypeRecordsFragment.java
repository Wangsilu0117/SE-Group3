 ...
 */
public class StoreTypeRecordsFragment extends BaseFragment {
    private static final String TAG = me.bakumon.moneykeeper.ui.storetyperecords.StoreTypeRecordsFragment.class.getSimpleName();
    public static final int SORT_TIME = 0;
    public static final int SORT_MONEY = 1;

    private FragmentTypeRecordsBinding mBinding;
    private StoreTypeRecordsViewModel mViewModel;
    ...
    public static StoreTypeRecordsFragment newInstance(int sortType, int recordType, int recordTypeId, int year, int month) {
        StoreTypeRecordsFragment fragment = new StoreTypeRecordsFragment();
    ...
    protected void onInit(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this, viewModelFactory).get(StoreTypeRecordsViewModel.class);
    ...
    private void getData() {
        mDisposable.add(mViewModel.getStoreRecordWithTypesSortMoney(mSortType, mRecordType, mRecordTypeId, mYear, mMonth)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())

 ...
 */
public class ProjectTypeRecordsActivity extends BaseActivity {
    ...
    private void setUpFragment() {
        ...
        ProjectTypeRecordsFragment timeSortFragment = ProjectTypeRecordsFragment.newInstance(ProjectTypeRecordsFragment.SORT_TIME, mRecordType, mRecordTypeId, mYear, mMonth);
        ProjectTypeRecordsFragment moneySortFragment = ProjectTypeRecordsFragment.newInstance(ProjectTypeRecordsFragment.SORT_MONEY, mRecordType, mRecordTypeId, mYear, mMonth);

...
public class AccountMonthChartFragment extends BaseFragment {

    private static final String TAG = AccountMonthChartFragment.class.getSimpleName();
    private FragmentAccountReportsBinding mBinding;
    private AccountMonthChartViewModel mViewModel;
    ...
    protected void onInit(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this, viewModelFactory).get(AccountMonthChartViewModel.class);
    ...
    private void initView() {
        ...
        mBinding.rgType.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            getTypeSumMoney_Account();
            getMonthSumMoney_Account();
        });
    }
    ...
    private void getMonthSumMoney_Account() {
        mDisposable.add(mViewModel.getMonthSumMoney_Account(AccountBillActivity.account_id, mYear, mMonth)     // lxy：现金账户
    ...
    private void getTypeSumMoney_Account() {
        mDisposable.add(mViewModel.getTypeSumMoney_Account(AccountBillActivity.account_id, mYear, mMonth, mType) // lxy:现金账户
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())

 ...
 */
public class ProjectTypeRecordsFragment extends BaseFragment {
    private static final String TAG = me.bakumon.moneykeeper.ui.projecttyperecords.ProjectTypeRecordsFragment.class.getSimpleName();
    public static final int SORT_TIME = 0;
    public static final int SORT_MONEY = 1;

    private FragmentTypeRecordsBinding mBinding;
    private ProjectTypeRecordsViewModel mViewModel;
    private HomeAdapter mSortTimeAdapter;
    private me.bakumon.moneykeeper.ui.typerecords.RecordAdapter mSortMoneyAdapter;
    ...
    public static ProjectTypeRecordsFragment newInstance(int sortType, int recordType, int recordTypeId, int year, int month) {
        ProjectTypeRecordsFragment fragment = new ProjectTypeRecordsFragment();
    ...
    protected void onInit(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this, viewModelFactory).get(ProjectTypeRecordsViewModel.class);
    ...
    private void getData() {
        mDisposable.add(mViewModel.getProjectRecordWithTypesSortMoney(mSortType, mRecordType, mRecordTypeId, mYear, mMonth)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())

 ...
 */
public class AccountBillFragment extends BaseFragment {

    private static final String TAG = me.bakumon.moneykeeper.ui.accountbill.AccountBillFragment.class.getSimpleName();
    private FragmentBillBinding mBinding;
    private AccountBillViewModel mViewModel;
    ...
    protected void onInit(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this, viewModelFactory).get(AccountBillViewModel.class);
    ...
    private void getOrderData() {
        mDisposable.add(mViewModel.getRecordWithTypes_Account(AccountBillActivity.account_id,mYear, mMonth, mType)    // 现金账户
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    private void getDaySumData() {
        mDisposable.add(mViewModel.getDaySumMoney_Account(AccountBillActivity.account_id, mYear, mMonth, mType)     // 现金账户
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    private void getMonthSumMoney() {
        mDisposable.add(mViewModel.getMonthSumMoney_Account(AccountBillActivity.account_id, mYear, mMonth)         // 现金账户
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())

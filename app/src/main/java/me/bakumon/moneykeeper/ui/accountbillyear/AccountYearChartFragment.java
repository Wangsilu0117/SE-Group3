...
public class AccountYearChartFragment extends BaseFragment {

    private static final String TAG = AccountYearChartFragment.class.getSimpleName();
    private FragmentAccountReportsBinding mBinding;
    private AccountYearChartViewModel mViewModel;
    ...
    protected void onInit(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this, viewModelFactory).get(AccountYearChartViewModel.class);
    ...
    private void getSumMoney_Account() {
        mDisposable.add(mViewModel.getSumMoney_Account(AccountBillYearActivity.account_id, mYear)     // lxy：现金账户
    ...
    private void getTypeSumMoney_Account() {
        mDisposable.add(mViewModel.getTypeSumMoney_Account(AccountBillYearActivity.account_id, mYear, mMonth, mType) // lxy:现金账户
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())

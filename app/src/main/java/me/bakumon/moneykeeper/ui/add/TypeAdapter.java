...
//        if (data != null && data.size() > 0 && mType!=RecordType.TYPE_TRANSFER) {
        if (data != null && data.size() > 0){
            ...
            RecordType settingItem = new RecordType(App.getINSTANCE().getString(R.string.text_setting), "type_item_setting", -1,-1);

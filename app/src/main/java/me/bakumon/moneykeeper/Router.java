...
public class Router {
    ...
    public static class Url {
        ...
        public static final String URL_ACCOUNT_MANAGE = "account_manage";
        public static final String URL_ADD_ACCOUNT = "add_account";

        public static final String URL_ACCOUNT = "account";
        public static final String URL_ACCOUNT_WATER = "account_water";
        public static final String URL_ACCOUNT_BILL = "account_bill";
        public static final String URL_ACCOUNT_BILL_YEAR = "account_bill_year";

        public static final String URL_MEMBER_MANAGE = "member_manage";
        public static final String URL_ADD_MEMBER = "add_member";


        public static final String URL_STORE_TYPE_RECORDS = "store_type_records";
        public static final String URL_PROJECT_TYPE_RECORDS = "project_type_records";
    }
    ...
    public static class ExtraKey {
        ...
        //新加————————————————————————————————————
        public static final String KEY_ACCOUNT_BEAN = "key_type_bean";
        //lxy
        public static final String KEY_ACCOUNT_ID = "key_account_id";
        //WSL
        public static final String KEY_MEMBER_BEAN = "key_type_bean";
    }
}

...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        mappings.put(Router.Url.URL_MEMBER, new Target("mk://bakumon.me/member"));
        mappings.put(Router.Url.URL_ACCOUNT_MANAGE, new Target("mk://bakumon.me/accountManage"));
        mappings.put(Router.Url.URL_ADD_ACCOUNT, new Target("mk://bakumon.me/addAccount"));

        mappings.put(Router.Url.URL_ACCOUNT, new Target("mk://bakumon.me/account"));
        mappings.put(Router.Url.URL_ACCOUNT_WATER, new Target("mk://bakumon.me/accountWater"));
        mappings.put(Router.Url.URL_ACCOUNT_BILL, new Target("mk://bakumon.me/accountBill"));
        mappings.put(Router.Url.URL_ACCOUNT_BILL_YEAR, new Target("mk://bakumon.me/accountBillYear"));

        mappings.put(Router.Url.URL_MEMBER_MANAGE, new Target("mk://bakumon.me/memberManage"));
        mappings.put(Router.Url.URL_ADD_MEMBER, new Target("mk://bakumon.me/addMember"));


        mappings.put(Router.Url.URL_STORE_TYPE_RECORDS, new Target("mk://bakumon.me/storeTypeRecords"));
        mappings.put(Router.Url.URL_PROJECT_TYPE_RECORDS, new Target("mk://bakumon.me/projectTypeRecords"));
